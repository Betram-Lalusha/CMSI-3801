 ...
 * @param {Number} amount Number of cents to convert into change
 ...
 * @param {String} inputString String to stretch
 ...
 * @param {String} phrase Phrase to add to the chain of words to say
 * @returns {String} Empty string if the function is called without an argument or the complete phrase of all given string arguments separated by spaces
 */
 ...
 * @param {Number} base Base number to obtain powers of
 * @param {Number} limit Number that, when reached, stops calculation of further powers
...
/**
 * Returns the top ten players by points-per-game among
 * @param {Object} list Object containing arrays of player names, games played, and total points
 * @returns Array of players, with each object holding a name, number of points per game, and a team
 */
export function topTenScorers(list) {
  return Object.entries(list)
    ...
    .map(([name, totalGames, points, team]) => ({
      name,
      ppg: points / totalGames,
      team,
    }))
 ...
 * @param {String} pokemonName Name of Pokémon to obtain data of
...
/**
 * Quaternion class with three methods: plus, times, and coefficients.
 */
export class Quaternion {
   ...
   * @param {Quaternion} other Quaternion to add to this one
   * @returns {Quaternion} New Quaternion whose coefficients are the sum of the respective indexes in the two Quaternions being added
   */
  plus(other) {
   ...
   * Note: Uses rules from https://www.mathworks.com/help/aeroblks/quaternionmultiplication.html#mw_48cb7d03-514d-4b24-8423-66c731cd4415
   * @param {Quaternion} other Quaternion to multiply with this one
   * @returns {Quaternion} New Quaternion which is the product of the original and argument Quaternions
   */
  times(other) {
    let product = []
    ...
    let t0 =
      ...
      this.#num3 * other.num3
    let t1 =
      this.#num0 * other.num1 +
      this.#num1 * other.num0 +
      this.#num2 * other.num3 -
      this.#num3 * other.num2
    let t2 =
      this.#num0 * other.num2 -
      this.#num1 * other.num3 +
      this.#num2 * other.num0 +
      this.#num3 * other.num1
    let t3 =
      this.#num0 * other.num3 +
      this.#num1 * other.num2 -
      this.#num2 * other.num1 +
      this.#num3 * other.#num0
    return new Quaternion(t0, t1, t2, t3)
  }

  /**
   * Gets coefficients of the Quaternion
